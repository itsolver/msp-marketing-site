...
(async () => {
    ...
    if (payment === 'card') {
      ...
      switch (payment) {
        ...
        case 'ach_credit_transfer':
          ...
          sourceData.owner.email = `amount_${order.amount}@itsolver.net`;
          break;
      }
  ...
  const handleSubscription = async (email, source, shipping, info, error = null) => {
    console.log(email, source, shipping, info);
  ...
  const handleOrder = async (order, source, error = null) => {
    ...
    switch (order.metadata.status) {
      ...
      case 'paid':
        ...
        confirmationElement.querySelector('.note').innerText ='Please <a href="https://www.itsolver.net/cal">book a session with Angus</a>';
        mainElement.classList.add('success');
        console.info('Success! Payment is confirmed.');
        break;
    }
  };
